...
" decoding="async" data-nimg="fill" style={{ position: 'absolute', inset: '0px', boxSizing: 'border-box', padding: '0px', border: '0px none rgb(0, 0, 0)', margin: 'auto', display: 'block', width: '0px', height: '271.2px', minWidth: '100%', maxWidth: '100%', minHeight: '100%', maxHeight: '100%', borderStyle: 'none' }} />
                        ...
                        <div style={{ gridColumn: '7 / -1', boxSizing: 'border-box' }}>
                            <div style={{ paddingx: 0, paddingy: 0, overflow: 'hidden', boxSizing: 'border-box', position: 'relative', padding: '0px', height: '271.2px', borderRadius: '16px', backgroundColor: 'rgb(255, 255, 255)', boxShadow: 'rgba(3, 0, 92, 0.05) 0px 1px 4px 0px', display: 'flex', flexDirection: 'column', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '100%', cursor: 'pointer' }}>
                                <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '271.2px', boxSizing: 'border-box' }}>
...
" decoding="async" data-nimg="fill" style={{ position: 'absolute', inset: '0px', boxSizing: 'border-box', padding: '0px', border: '0px none rgb(0, 0, 0)', margin: 'auto', display: 'block', width: '0px', height: '0px', minWidth: '100%', maxWidth: '100%', minHeight: '100%', maxHeight: '100%', borderStyle: 'none' }} /></span></div>
                                    ...
                                    <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                        <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                            ...
                                            </a><a href="https://twitter.com/SuiNetwork" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
...
"decoding="async" data-nimg="fill" style={{ position: 'absolute', inset: '0px', boxSizing: 'border-box', padding: '0px', border: '0px none rgb(0, 0, 0)', margin: 'auto', display: 'block', width: '0px', height: '0px', minWidth: '100%', maxWidth: '100%', minHeight: '100%', maxHeight: '100%', borderStyle: 'none' }} /></span></div>
                ...
                <section style={{ marginTop: '64px', gridColumn: '1 / -1', boxSizing: 'border-box' }}>
                    ...
                    <div style={{ display: 'grid', gap: '24px', gridAutoRows: '1fr', gridTemplateColumns: '576px 576px', WebkitBoxPack: 'center', justifyContent: 'center', boxSizing: 'border-box' }}>
                        <div style={{ paddingx: 0, paddingy: 0, overflow: 'hidden', boxSizing: 'border-box', position: 'relative', padding: '0px', height: '314.4px', borderRadius: '16px', backgroundColor: 'rgb(255, 255, 255)', boxShadow: 'rgba(3, 0, 92, 0.05) 0px 1px 4px 0px', display: 'flex', flexDirection: 'column', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '100%', cursor: 'pointer' }}>
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        <div style={{ display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://hackwithindia.live" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://discord.gg/g5TFSVjr" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                            ...
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://twitter.com/HackBlocks" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                    <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                </g>
                                        ...
                                        </a><a href="https://www.instagram.com/hackblocks/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                            ...
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://www.ethbratislava.com/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://twitter.com/ETH_Bratislava" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                        ...
                        <div style={{ paddingx: 0, paddingy: 0, overflow: 'hidden', boxSizing: 'border-box', position: 'relative', padding: '0px', height: '314.4px', borderRadius: '16px', backgroundColor: 'rgb(255, 255, 255)', boxShadow: 'rgba(3, 0, 92, 0.05) 0px 1px 4px 0px', display: 'flex', flexDirection: 'column', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '100%', cursor: 'pointer' }}>
                            <div className="ptu" height="100%" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        <div style={{ display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://www.hackaventus.com/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://discord.gg/qH2nW7u4ZW" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="discord" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <path d="M15.306 3.5s2.658.443 4.541 1.758c.12.084.215.197.278.33 1.344 2.829 2.658 8.51 2.733 11.793a.784.784 0 01-.166.515c-1.018 1.26-3.435 2.457-5.579 2.592a.68.68 0 01-.628-.297C16.104 19.588 16 19 16 19M8.695 3.5s-2.659.443-4.542 1.758a.839.839 0 00-.278.33c-1.343 2.829-2.658 8.51-2.733 11.793a.784.784 0 00.166.515c1.018 1.26 3.435 2.457 5.58 2.592a.68.68 0 00.627-.297C7.896 19.588 8 19 8 19M6 7c2.212-1.078 3.54-1.5 6-1.5s3.789.422 6 1.5M6 17c2.212 1.078 3.54 1.5 6 1.5s3.789-.422 6-1.5m-4.5-4c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2zm-6 0c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                                            </a></div>
                                    ...
                                    <div  height="max-content" style={{ flexDirection: 'row', display: 'flex', alignItems: 'flex-end', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '80px', padding: '16px 24px', boxSizing: 'border-box' }}>
                                        <div direction="row" wrap="wrap" style={{ alignSelf: 'flex-start', display: 'flex', flexFlow: 'row wrap', gap: '8px', boxSizing: 'border-box' }}>
                                            <div style={{ whiteSpace: 'normal', backgroundColor: 'rgb(245, 247, 247)', padding: '16px', borderRadius: '16px', boxSizing: 'border-box' }}>
                                                <p style={{ fontSize: '12px', lineHeight: '16px', letterSpacing: '1.44px', fontWeight: 700, color: 'rgb(56, 71, 78)', fontFamily: 'Montserrat, sans-serif', margin: '0px', textTransform: 'uppercase', boxSizing: 'border-box' }}>Offline</p>
                                            </div>
                            ...
                            <div className="ptu" height="100%" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://storyprotocol.notion.site/Story-Protocol-v1-0-Buildathon-22331636231745d0aea0c5407c76d2b2?pvs=4" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://twitter.com/storyprotocol" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                            ...
                            <div className="ptu" height="100%" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://www.facebook.com/MLSCDSU" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                        ...
                                        </a><a href="https://www.instagram.com/azure_fest/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="instagram" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <rect x={2} y={2} width={20} height={20} rx={5} ry={5} style={{ boxSizing: 'border-box' }} />
                                                    <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zM17.5 6.5h0" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                            ...
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://www.instagram.com/hackfest_mmmut/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="instagram" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <rect x={2} y={2} width={20} height={20} rx={5} ry={5} style={{ boxSizing: 'border-box' }} />
                                                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zM17.5 6.5h0" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                            ...
                            <div className="ptu" height="100%" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        </a><a href="https://twitter.com/__zkhack__" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                            ...
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://ethprague.com" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://x.com/ethprague" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                            ...
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://technoxian.netlify.app/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://www.instagram.com/cac.cuchd/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="instagram" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <rect x={2} y={2} width={20} height={20} rx={5} ry={5} style={{ boxSizing: 'border-box' }} />
                                                    <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zM17.5 6.5h0" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                            ...
                            <div height="100%" direction="[object Object]"  className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://www.codeclash.tech/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://twitter.com/CodeClashGLB" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                        ...
                        <div style={{ paddingx: 0, paddingy: 0, overflow: 'hidden', boxSizing: 'border-box', position: 'relative', padding: '0px', height: '314.4px', borderRadius: '16px', backgroundColor: 'rgb(255, 255, 255)', boxShadow: 'rgba(3, 0, 92, 0.05) 0px 1px 4px 0px', display: 'flex', flexDirection: 'column', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '100%', cursor: 'pointer' }}>
                            <div height="100%" direction="[object Object]" className="ptu" 
                            style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        <div style={{ display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://www.quantamaze.dev/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://discord.com/invite/pJB5zKGPZt" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="discord" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <path d="M15.306 3.5s2.658.443 4.541 1.758c.12.084.215.197.278.33 1.344 2.829 2.658 8.51 2.733 11.793a.784.784 0 01-.166.515c-1.018 1.26-3.435 2.457-5.579 2.592a.68.68 0 01-.628-.297C16.104 19.588 16 19 16 19M8.695 3.5s-2.659.443-4.542 1.758a.839.839 0 00-.278.33c-1.343 2.829-2.658 8.51-2.733 11.793a.784.784 0 00.166.515c1.018 1.26 3.435 2.457 5.58 2.592a.68.68 0 00.627-.297C7.896 19.588 8 19 8 19M6 7c2.212-1.078 3.54-1.5 6-1.5s3.789.422 6 1.5M6 17c2.212 1.078 3.54 1.5 6 1.5s3.789-.422 6-1.5m-4.5-4c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2zm-6 0c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                                            </a></div>
                            ...
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a className="ptu"href="https://twitter.com/Hack_0verflow"  style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                    <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                </g>
                                        ...
                                        </a><a href="https://discord.gg/WX5a6qdYPH" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="discord" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <path d="M15.306 3.5s2.658.443 4.541 1.758c.12.084.215.197.278.33 1.344 2.829 2.658 8.51 2.733 11.793a.784.784 0 01-.166.515c-1.018 1.26-3.435 2.457-5.579 2.592a.68.68 0 01-.628-.297C16.104 19.588 16 19 16 19M8.695 3.5s-2.659.443-4.542 1.758a.839.839 0 00-.278.33c-1.343 2.829-2.658 8.51-2.733 11.793a.784.784 0 00.166.515c1.018 1.26 3.435 2.457 5.58 2.592a.68.68 0 00.627-.297C7.896 19.588 8 19 8 19M6 7c2.212-1.078 3.54-1.5 6-1.5s3.789.422 6 1.5M6 17c2.212 1.078 3.54 1.5 6 1.5s3.789-.422 6-1.5m-4.5-4c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2zm-6 0c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                                            </a></div>
                            ...
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}>
                                            <a href="https://discord.com/channels/1229137722384580699/1229137722384580701" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="discord" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M15.306 3.5s2.658.443 4.541 1.758c.12.084.215.197.278.33 1.344 2.829 2.658 8.51 2.733 11.793a.784.784 0 01-.166.515c-1.018 1.26-3.435 2.457-5.579 2.592a.68.68 0 01-.628-.297C16.104 19.588 16 19 16 19M8.695 3.5s-2.659.443-4.542 1.758a.839.839 0 00-.278.33c-1.343 2.829-2.658 8.51-2.733 11.793a.784.784 0 00.166.515c1.018 1.26 3.435 2.457 5.58 2.592a.68.68 0 00.627-.297C7.896 19.588 8 19 8 19M6 7c2.212-1.078 3.54-1.5 6-1.5s3.789.422 6 1.5M6 17c2.212 1.078 3.54 1.5 6 1.5s3.789-.422 6-1.5m-4.5-4c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2zm-6 0c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a
                                        ><a href="https://www.instagram.com/projectecho.igdtuw/?hl=en" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="instagram" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <rect x={2} y={2} width={20} height={20} rx={5} ry={5} style={{ boxSizing: 'border-box' }} />
                                                    <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zM17.5 6.5h0" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                            ...
                            <div height="100%" direction="[object Object]" className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}>
                                            <a href="https://kleos-production.netlify.app/home" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://twitter.com/RaitACM" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                        ...
                        <div className="ptu" style={{ paddingx: 0, paddingy: 0, overflow: 'hidden', boxSizing: 'border-box', position: 'relative', padding: '0px', height: '314.4px', borderRadius: '16px', backgroundColor: 'rgb(255, 255, 255)', boxShadow: 'rgba(3, 0, 92, 0.05) 0px 1px 4px 0px', display: 'flex', flexDirection: 'column', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '100%', cursor: 'pointer' }}>
                            <div height="100%" className="ptu"
                             direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        <div style={{ display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}>
                                            <a href="https://hackprix.tech" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://twitter.com/codewavehub" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                        ...
                        <div style={{ paddingx: 0, paddingy: 0, overflow: 'hidden', boxSizing: 'border-box', position: 'relative', padding: '0px', height: '314.4px', borderRadius: '16px', backgroundColor: 'rgb(255, 255, 255)', boxShadow: 'rgba(3, 0, 92, 0.05) 0px 1px 4px 0px', display: 'flex', flexDirection: 'column', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '100%', cursor: 'pointer' }}>
                            <div height="100%" className="ptu" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '314.4px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        <div style={{ display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://www.twitter.com/vinyasaCSD" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                    <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                </g>
                                        ...
                                        </a><a href="https://www.instagram.com/vsoc_csd" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="instagram" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <rect x={2} y={2} width={20} height={20} rx={5} ry={5} style={{ boxSizing: 'border-box' }} />
                                                    <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zM17.5 6.5h0" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                ...
                <section style={{ marginTop: '64px', gridColumn: '1 / -1', boxSizing: 'border-box' }}>
                    ...
                    <div style={{ display: 'grid', gap: '24px', gridAutoRows: '1fr', gridTemplateColumns: '576px 576px', WebkitBoxPack: 'center', justifyContent: 'center', boxSizing: 'border-box' }}>
                        <div style={{ paddingx: 0, paddingy: 0, overflow: 'hidden', boxSizing: 'border-box', position: 'relative', padding: '0px', height: '271.2px', borderRadius: '16px', backgroundColor: 'rgb(255, 255, 255)', boxShadow: 'rgba(3, 0, 92, 0.05) 0px 1px 4px 0px', display: 'flex', flexDirection: 'column', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '100%', cursor: 'pointer' }}>
                            <div height="100%" className="ptu" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '271.2px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        <div style={{ display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://sparkthesummer.tech/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://x.com/SparkTheSummer" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                                    ...
                                    <div
                                     direction="[object Object]" height="max-content" style={{ flexDirection: 'row', display: 'flex', alignItems: 'flex-end', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '80px', padding: '16px 24px', boxSizing: 'border-box' }}>
                                        <div direction="row" wrap="wrap" style={{ alignSelf: 'flex-start', display: 'flex', flexFlow: 'row wrap', gap: '8px', boxSizing: 'border-box' }}>
                                            <div style={{ whiteSpace: 'normal', backgroundColor: 'rgb(245, 247, 247)', padding: '16px', borderRadius: '16px', boxSizing: 'border-box' }}>
                                                <p style={{ fontSize: '12px', lineHeight: '16px', letterSpacing: '1.44px', fontWeight: 700, color: 'rgb(56, 71, 78)', fontFamily: 'Montserrat, sans-serif', margin: '0px', textTransform: 'uppercase', boxSizing: 'border-box' }}>Offline</p>
                                            </div>
                            ...
                            <div height="100%" className="ptu" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '271.2px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://twitter.com/Dimo_Hack" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                    <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                </g>
                            ...
                            <div height="100%" className="ptu"  direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '271.2px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://www.facebook.com/InnoFusionHackathon" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="facebook" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://discord.gg/wRRqeN23a5" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="discord" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <path d="M15.306 3.5s2.658.443 4.541 1.758c.12.084.215.197.278.33 1.344 2.829 2.658 8.51 2.733 11.793a.784.784 0 01-.166.515c-1.018 1.26-3.435 2.457-5.579 2.592a.68.68 0 01-.628-.297C16.104 19.588 16 19 16 19M8.695 3.5s-2.659.443-4.542 1.758a.839.839 0 00-.278.33c-1.343 2.829-2.658 8.51-2.733 11.793a.784.784 0 00.166.515c1.018 1.26 3.435 2.457 5.58 2.592a.68.68 0 00.627-.297C7.896 19.588 8 19 8 19M6 7c2.212-1.078 3.54-1.5 6-1.5s3.789.422 6 1.5M6 17c2.212 1.078 3.54 1.5 6 1.5s3.789-.422 6-1.5m-4.5-4c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2zm-6 0c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                                            </a></div>
                ...
                <section style={{ marginTop: '64px', gridColumn: '1 / -1', boxSizing: 'border-box' }}>
                    <div   direction="[object Object]" style={{ flexDirection: 'row', gap: '24px', marginBottom: '48px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                        ...
                        <div className="btnui"height={1} style={{ display: 'flex', WebkitBoxFlex: 1, flexGrow: 1, height: '1px', backgroundColor: 'rgb(208, 217, 218)', boxSizing: 'border-box' }} /><a href="/hackathons/past" style={{ display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', boxSizing: 'border-box', width: 'auto', height: '44px', padding: '0px 16px', border: '0px none rgb(55, 112, 255)', borderRadius: '8px', margin: '0px', boxShadow: 'none', backgroundColor: 'rgb(210, 224, 255)', color: 'rgb(55, 112, 255)', fontFamily: '"Nunito Sans", sans-serif', fontSize: '16px', fontWeight: 700, whiteSpace: 'nowrap', outline: 'rgb(55, 112, 255) none 0px', userSelect: 'none', textDecoration: 'none solid rgb(55, 112, 255)', WebkitTapHighlightColor: 'rgba(0, 0, 0, 0)' }} className="btnui">
                    ...
                    <div style={{ display: 'grid', gap: '24px', gridAutoRows: '1fr', gridTemplateColumns: '576px 576px', WebkitBoxPack: 'center', justifyContent: 'center', boxSizing: 'border-box' }}>
                            ...
                            <div height="100%" className="ptu" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '271.2px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        </button><a href="https://www.eduminerva.live/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                    <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                                            </a><a href="https://discord.com/invite/nPJUMbEw8S" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="discord" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <path d="M15.306 3.5s2.658.443 4.541 1.758c.12.084.215.197.278.33 1.344 2.829 2.658 8.51 2.733 11.793a.784.784 0 01-.166.515c-1.018 1.26-3.435 2.457-5.579 2.592a.68.68 0 01-.628-.297C16.104 19.588 16 19 16 19M8.695 3.5s-2.659.443-4.542 1.758a.839.839 0 00-.278.33c-1.343 2.829-2.658 8.51-2.733 11.793a.784.784 0 00.166.515c1.018 1.26 3.435 2.457 5.58 2.592a.68.68 0 00.627-.297C7.896 19.588 8 19 8 19M6 7c2.212-1.078 3.54-1.5 6-1.5s3.789.422 6 1.5M6 17c2.212 1.078 3.54 1.5 6 1.5s3.789-.422 6-1.5m-4.5-4c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2zm-6 0c0 1 .5 2 1.5 2s1.5-1 1.5-2-.5-2-1.5-2-1.5 1-1.5 2z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                                            </a></div>
                        ...
                        <div style={{ paddingx: 0, paddingy: 0, overflow: 'hidden', boxSizing: 'border-box', position: 'relative', padding: '0px', height: '271.2px', borderRadius: '16px', backgroundColor: 'rgb(255, 255, 255)', boxShadow: 'rgba(3, 0, 92, 0.05) 0px 1px 4px 0px', display: 'flex', flexDirection: 'column', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '100%', cursor: 'pointer' }}>
                            <div  className="ptu"height="100%" direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '271.2px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        <div style={{ display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', boxSizing: 'border-box' }}>
                                        ...
                                        </button><a href="https://www.sprinthacks.in/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                    <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                                            </a><a href="https://twitter.com/dsckiet" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="twitter" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <g clipPath="url(#prefix__clip0_9809_761)" style={{ boxSizing: 'border-box' }}>
                                                        <path d="M.059 1l9.266 12.39L0 23.463h2.099l8.163-8.82 6.596 8.82H24l-9.787-13.087L22.892 1h-2.099l-7.518 8.122L7.2 1H.06zm3.086 1.546h3.28l14.488 19.371h-3.28L3.145 2.546z" fill="currentColor" style={{ boxSizing: 'border-box' }} />
                                                    </g>
                            ...
                            <div height="100%" className="ptu"  direction="[object Object]" style={{ flexDirection: 'row', display: 'flex', height: '271.2px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        </button><a href="https://hackify.iedcmace.in/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                    <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                                            </a><a href="https://www.instagram.com/hackify.mace" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="instagram" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <rect x={2} y={2} width={20} height={20} rx={5} ry={5} style={{ boxSizing: 'border-box' }} />
                                                    <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zM17.5 6.5h0" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
                            ...
                            <div height="100%" direction="[object Object]"  className="ptu" style={{ flexDirection: 'row', display: 'flex', height: '271.2px', boxSizing: 'border-box' }}>
                                <div direction="column" style={{ display: 'flex', flexDirection: 'column', flex: '1 1 0%', WebkitBoxPack: 'justify', justifyContent: 'space-between', boxSizing: 'border-box' }}>
                                    <div wrap="[object Object]" height="max-content" style={{ flexWrap: 'nowrap', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', gap: '16px', WebkitBoxPack: 'justify', justifyContent: 'space-between', height: '100px', padding: '24px', boxSizing: 'border-box' }}>
                                        ...
                                        <div direction="row" style={{ display: 'flex', flexDirection: 'row', gap: '8px', boxSizing: 'border-box' }}><a href="https://glbhackathon.netlify.app/" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                            <div name="link" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" style={{ boxSizing: 'border-box' }} />
                                                <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" style={{ boxSizing: 'border-box' }} />
                                            </svg></div>
                                        </a><a href="https://www.instagram.com/techvisor_glbajaj/?hl=en" className="ptu" style={{ padding: '12px', margin: '0px', display: 'flex', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', border: '0px none rgb(0, 0, 238)', borderRadius: '24px', backgroundColor: 'rgb(240, 244, 255)', cursor: 'pointer', outline: 'rgb(0, 0, 238) none 0px', textDecoration: 'none solid rgb(0, 0, 238)', boxSizing: 'border-box' }}>
                                                <div name="instagram" color="blue-4" style={{ display: 'block', height: '24px', width: '24px', boxSizing: 'border-box' }}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ height: '24px', width: '24px', color: 'rgb(55, 112, 255)', boxSizing: 'border-box' }}>
                                                    <rect x={2} y={2} width={20} height={20} rx={5} ry={5} style={{ boxSizing: 'border-box' }} />
                                                    <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zM17.5 6.5h0" style={{ boxSizing: 'border-box' }} />
                                                </svg></div>
